...
type IRestTodosApi =
    { 
        getAllTodos: unit -> Async<Todo list>
        addTodo: Todo -> Async<Todo>
        removeTodo: Guid -> Async<Guid>
        getAllCategories: unit -> Async<Category list>
        addCategory: Category -> Async<Category>
        removeCategory: Guid -> Async<Guid>
        addTag: Tag -> Async<Tag>
        removeTag: Guid -> Async<Guid>  
        getAllTags: unit -> Async<Tag list>
    }
